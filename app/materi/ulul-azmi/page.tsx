  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#667eea] to-[#764ba2] font-poppins relative overflow-x-hidden pb-20">
      ...
      <div className="container mx-auto px-4 py-4 flex-grow">
        <div id="mainContent">
          <div className="adventure-map grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4 md:gap-6 mb-8">
          ...
          <div className="text-center mb-6">
            <h2 className="text-3xl font-bold text-white mb-2">🎮 Games Seru</h2>
            <p className="text-white/80 mb-6">Belajar sambil bermain dengan games interaktif</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Link href="/materi/ulul-azmi/games/memory">
              <div className="bg-gradient-to-br from-yellow-400/20 to-orange-400/20 backdrop-blur-md p-6 rounded-2xl border border-white/30 shadow-lg hover:bg-white/20 transition-all transform hover:-translate-y-2">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">Permainan Memori</h3>
                  <p className="text-white/80 text-sm">Temukan pasangan kartu yang sama dengan tema Nabi Ulul Azmi</p>
                </div>
              </div>
            </Link>

            <Link href="/materi/ulul-azmi/games/quiz">
              <div className="bg-gradient-to-br from-blue-400/20 to-purple-400/20 backdrop-blur-md p-6 rounded-2xl border border-white/30 shadow-lg hover:bg-white/20 transition-all transform hover:-translate-y-2">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">Kuis Seru</h3>
                  <p className="text-white/80 text-sm">Uji pengetahuanmu tentang Nabi Ulul Azmi dengan kuis interaktif</p>
                </div>
              </div>
            </Link>
          </div>
